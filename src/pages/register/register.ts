...
export class RegisterPage {
  ...
  seeProtocol(){
    let protocol = "邂逅思念软件服务协议\n" +
      ...
      "本协议约定来布科技与用户之间关于“邂逅思念”软件服务（以下简称“服务”）的权利义务。“用户”是指注册、登录、使用本服务的个人。本协议可由来布科技随时更新，更新后的协议条款一旦公布即代替原来的协议条款，恕不再另行通知，用户可在本网站查阅最新版协议条款。在来布科技修改协议条款后，如果用户不接受修改后的条款，请立即停止使用来布科技提供的服务，用户继续使用来布科技提供的服务将被视为接受修改后的协议。\n" +
      "一、账号注册\n" +
      "1、用户在使用本服务前需要注册一个“邂逅思念”账号。“邂逅思念”账号应当使用手机号码绑定注册，请用户使用尚未与“邂逅思念”账号绑定的手机号码，以及未被来布科技根据本协议封禁的手机号码注册“邂逅思念”账号。来布科技可以根据用户需求或产品需要对账号注册和绑定的方式进行变更，而无须事先通知用户。 \n" +
      "2、鉴于“邂逅思念”账号的绑定注册方式，您同意来布科技在注册时将使用您提供的手机号码自动提取您的手机设备识别码等信息用于注册。 \n" +
      ...
      "4、“邂逅思念”是一款面向有明确结婚意向的单身人士的实名制移动社交产品，用户需要向“邂逅思念”提交可以证实自己个人信息真实性的包括但不限于用户的身份证件号码及正反面照片、护照证件号码及照片、学历学位证书正面照片、房产证件正面照片、汽车行驶证件正面照片，“邂逅思念”有权对用户提交的认证信息进行审核并且确认通过或者否决通过。用户无法通过“邂逅思念”的信息认证审核将无法使用“邂逅思念”提供的包括但不限于即时通讯、关注他人产品功能，但可以查看其他会员的公开资料及使用“邂逅思念”提供的条件搜索功能。“邂逅思念”将对用户提交的用于个人信息真实性认证的资料进行严格的保密。\n" +
      "\n" +
      "二、服务内容\n" +
      "1、本服务的具体内容由来布科技根据实际情况提供，包括但不限于授权用户通过其账号进行即时通讯、关注他人、发布留言。来布科技可以对其提供的服务予以变更，且来布科技提供的服务内容可能随时变更；用户将会收到来布科技关于服务变更的通知。 \n" +
      "2、来布科技提供的服务包含免费服务与收费服务。用户可以通过付费方式购买收费服务，具体方式为：用户通过网上银行、支付宝或其他“邂逅思念”平台提供的付费途径支付一定数额的人民币，然后根据来布科技公布的资费标准购买用户欲使用的收费服务，从而获得收费服务使用权限。对于收费服务，来布科技会在用户使用之前给予用户明确的提示，只有用户根据提示确认其同意按照前述支付方式支付费用并完成了支付行为，用户才能使用该等收费服务。支付行为的完成以银行或第三方支付平台生成“支付已完成”的确认通知为准。\n" +
      "\n" +
      "三、用户个人隐私信息保护\n" +
      ...
      "6、来布科技重视对未成年人个人隐私信息的保护。来布科技将依赖用户提供的个人信息判断用户是否为未成年人。任何18岁以下的未成年人注册账号或使用本服务应事先取得家长或其法定监护人（以下简称\"监护人\"）的书面同意。除根据法律法规的规定及有权机关的指示披露外，来布科技不会使用或向任何第三方透露未成年人的聊天记录及其他个人隐私信息。除本协议约定的例外情形外，未经监护人事先同意，来布科技不会使用或向任何第三方透露未成年人的个人隐私信息。任何18岁以下的用户不得下载和使用来布科技通过邂逅思念软件提供的网络游戏。 \n" +
      "7、用户确认，其地理位置信息为非个人隐私信息，用户成功注册“邂逅思念”账号视为确认授权来布科技提取、公开及使用用户的地理位置信息。用户地理位置信息将作为用户公开资料之一，由来布科技向其他用户公开。如用户需要终止向其他用户公开其地理位置信息，可随时自行设置为隐身状态。 \n" +
      ...
      "2、用户不得利用“邂逅思念”账号或本服务制作、上载、复制、发布、传播如下法律、法规和政策禁止的内容：\n" +
      "(1) 反对宪法所确定的基本原则的； \n" +
      ...
      "3、用户不得利用“邂逅思念”账号或本服务制作、上载、复制、发布、传播如下干扰“邂逅思念”正常运营，以及侵犯其他用户或第三方合法权益的内容：\n" +
      "(1) 含有任何性或性暗示的； \n" +
      "(2) 含有辱骂、恐吓、威胁内容的； \n" +
      ...
      "2、用户不得利用“邂逅思念”账号或本服务进行如下行为：\n" +
      "(1) 提交、发布虚假信息，或盗用他人头像或资料，冒充、利用他人名义的； \n" +
      "(2) 强制、诱导其他用户关注、点击链接页面或分享信息的； \n" +
      "(3) 虚构事实、隐瞒真相以误导、欺骗他人的； \n" +
      "(4) 利用技术手段批量建立虚假账号的； \n" +
      "(5) 利用“邂逅思念”账号或本服务从事任何违法犯罪活动的； \n" +
      "(6) 制作、发布与以上行为相关的方法、工具，或对此类方法、工具进行运营或传播，无论这些行为是否为商业目的； \n" +
      "(7) 其他违反法律法规规定、侵犯其他用户合法权益、干扰“邂逅思念”正常运营或来布科技未明示授权的行为。\n" +
      "3、用户须对利用“邂逅思念”账号或本服务传送信息的真实性、合法性、无害性、准确性、有效性等全权负责，与用户所传播的信息相关的任何法律责任由用户自行承担，与来布科技无关。如因此给来布科技或第三方造成损害的，用户应当依法予以赔偿。 \n" +
      ...
      "\n" +
      "六、帐户管理\n" +
      "1、 “邂逅思念”账号的所有权归来布科技所有，用户完成申请注册手续后，获得“邂逅思念”账号的使用权，该使用权仅属于初始申请注册人，禁止赠与、借用、租用、转让或售卖。来布科技因经营需要，有权回收用户的“邂逅思念”账号。 \n" +
      "2、用户可以更改、删除“邂逅思念”帐户上的个人资料、注册信息及传送内容等，但需注意，删除有关信息的同时也会删除用户储存在系统中的文字和图片。用户需承担该风险。 \n" +
      ...
      "4、用户应遵守本协议的各项条款，正确、适当地使用本服务，如因用户违反本协议中的任何条款，来布科技在通知用户后有权依据协议中断或终止对违约用户“邂逅思念”账号提供服务。如用户后续再次注册的，迈优有权继续中断或终止对违约用户新注册的“邂逅思念”账号提供服务。同时，来布科技保留在任何时候收回“邂逅思念”账号、用户名的权利。 \n" +
      "5、如用户注册“邂逅思念”账号后一年不登录，通知用户后，来布科技可以收回该账号，以免造成资源浪费，由此造成的不利后果由用户自行承担。\n" +
      "\n" +
      "七、数据储存\n" +
      ...
      "\n" +
      "八、风险承担\n" +
      "1、用户理解并同意，“邂逅思念”仅为用户提供信息分享、传送及获取的平台，用户必须为自己注册账号下的一切行为负责，包括用户所传送的任何内容以及由此产生的任何后果。用户应对“邂逅思念”及本服务中的内容自行加以判断，并承担因使用内容而引起的所有风险，包括因对内容的正确性、完整性或实用性的依赖而产生的风险。来布科技无法且不会对因用户行为而导致的任何损失或损害承担责任。 如果用户发现任何人违反本协议约定或以其他不当的方式使用本服务，请立即向来布科技举报或投诉，来布科技将依本协议约定进行处理。 \n" +
      ...
      "5、用户理解并确认，来布科技需要定期或不定期地对“邂逅思念”平台或相关的设备进行检修或者维护，如因此类情况而造成服务在合理时间内的中断，来布科技无需为此承担任何责任，但来布科技应事先进行通告。 \n" +
      ...
      "9、在任何情况下，来布科技均不对任何间接性、后果性、惩罚性、偶然性、特殊性或刑罚性的损害，包括因用户使用“邂逅思念”或本服务而遭受的利润损失，承担责任（即使来布科技已被告知该等损失的可能性亦然）。尽管本协议中可能含有相悖的规定，来布科技对用户承担的全部责任，无论因何原因或何种行为方式，始终不超过用户因使用来布科技提供的服务而支付给来布科技的费用(如有)。\n" +
      "\n" +
      "十二、服务的变更、中断、终止\n" +
      "1、鉴于网络服务的特殊性，用户同意来布科技有权随时变更、中断或终止部分或全部的服务（包括收费服务）。来布科技变更、中断或终止的服务，来布科技应当在变更、中断或终止之前通知用户，并应向受影响的用户提供等值的替代性的服务；如用户不愿意接受替代性的服务，如果该用户已经向来布科技支付的邂逅思念币，来布科技应当按照该用户实际使用服务的情况扣除相应邂逅思念币之后将剩余的邂逅思念币退还用户的邂逅思念币账户中。 \n" +
      ...
      "\n" +
      "十三、服务说明与免责条款\n" +
      "1、“邂逅思念”仅保证用户的个人信息在认证阶段时的真实性，但不保证时效性，对于用户的个人素养“邂逅思念”也不担保，所有用户在使用产品功能进行聊天交友时需自己判断对方用户的个人品德等，做好自我防护，对于因用户个人品行等问题造成的后果将由用户自己承担。\n" +
      "\n" +
      "十四、其他\n" +
